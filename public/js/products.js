...
async function loadProductsByCategory() {
  try {
    const winterRes = await fetch("api/products?category=winter");
    const winterProducts = await winterRes.json();
    renderWinter(winterProducts);
    const festiveRes = await fetch("api/products?category=festive");
    const festiveProducts = await festiveRes.json();
    renderFestive(festiveProducts);
    const dailyRes = await fetch("api/products?category=daily");
    const dailyProducts = await dailyRes.json();
    renderDaily(dailyProducts);
    const accessoryRes = await fetch("api/products?category=accessory");
